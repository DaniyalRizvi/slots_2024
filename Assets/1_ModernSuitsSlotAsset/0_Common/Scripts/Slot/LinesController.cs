...
namespace Mkey
{
	public class LinesController : MonoBehaviour
    {
      ...
      //  private bool setLineVisible = false;
        ...
        public void SetWinText(WinData win)
        {
            winText.SetActive(true);
            winText.GetComponentInChildren<Text>().text = win.Symbols.Count + "x " + win.Symbols[0].GetSprite().name + " pays " + (win.Pay * win.PayMult * (controls.TotalBet/10) *MPlayer.StatusMultiplier).ToString("0#,0");
        }
        ...
        public void HideWinText()
        {
            if(winText != null)
            {
                ...
                winText.GetComponentInChildren<Text>().text = "";
            }
