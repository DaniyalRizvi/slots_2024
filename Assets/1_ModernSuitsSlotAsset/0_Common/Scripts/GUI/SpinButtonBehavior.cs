...
namespace Mkey
{
    public class SpinButtonBehavior : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IPointerExitHandler
    {
        ...
        [SerializeField] private Sprite normalSpin;
        [SerializeField] private Sprite holdSpin;

        [SerializeField] private ParticleSystem HoldEffects;
        ...
        private void SetButtonText()
        {
            if (autoText && slotControls)
            {
                ...
                GetComponent<Image>().sprite = (!slotControls.Auto) ? normalSpin : holdSpin;
